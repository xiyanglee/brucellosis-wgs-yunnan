...
head(sort(table(mrca.nodes.l13$height), decreasing = TRUE))
# 1037.01564352233 894.163131618388 64.0124731907478 3253.64482336171 48.9723381310289 24.7579398153786 
#             2712             1526               20               19               16               10 
...
head(sort(table(mrca.nodes.l11$height), decreasing = TRUE))
# 233.472616353011 218.714849597202  196.75513583888 395.065835391226 1037.01564352233 181.292766686633 
#.            3884             2184             1953             1616              948              637 
...
# 531.294912822049 1037.01564352233 894.163131618388 47.3555879868838 3253.64482336171 22.8591609869054 
#             1050               60               40               15                5                2
