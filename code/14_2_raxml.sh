...
# nohup bash 14_2_raxml.sh >> _log/raxml_panaroo.log 2>&1 &


cp ${PANAROO_OUT_DIR}/core_gene_alignment_filtered.aln ${PANAROO_TREE_DIR}/core_gene_alignment_filtered.aln
...
raxmlHPC-PTHREADS-AVX2 \
	-s ${PANAROO_TREE_DIR}/core_gene_alignment_filtered.aln \
	-n raxml_tree \
	-m GTRGAMMA \
	-T 12 \
	-N 1000 \
