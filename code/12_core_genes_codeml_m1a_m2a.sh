...
## chmod +x 12_core_genes_codeml_m1a_m2a.sh
## ./12_core_genes_codeml_m1a_m2a.sh

# 设置最大并发数
MAX_JOBS=10

# 根目录
BASE_DIR="/public/data_2/lxy/alto/project/brucella_wgs_Yunnan_2024/pipelines/denovo_ssembly/data/dnds_per_gene_m1a_vs_m2a"
