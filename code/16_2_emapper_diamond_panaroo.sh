...
# nohup bash 16_2_emapper_diamond_panaroo.sh >> _log/emapper_diamond_panaroo.log 2>&1 &
...
emapper.py \
    -i ${PANAROO_OUT_DIR}/pan_genome_reference.fa \
    -o pan_genome_annotation \
    --output_dir ${PANAROO_EMAPPER_DIAMOND_OUT_DIR} \
