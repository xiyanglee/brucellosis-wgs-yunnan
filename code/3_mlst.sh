...
do
    ...
    ln -s ${UNICYCLER_OUT_DIR}/${SAMPLE_NAME}/assembly.fasta ${FASTA_INPUT_DIR}/${SAMPLE_NAME}-assembly.fasta
done
...
do
    ...
    ln -s ${SOURCE_DIR}/assembly_genbank/genomes/${FILE_PREFIX}/${FILE_PREFIX}_genomic.fna.gz ${FASTA_INPUT_DIR}/${SAMPLE_NAME}-genebank.fna.gz
done
