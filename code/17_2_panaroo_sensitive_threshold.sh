...
# nohup bash 17_2_panaroo_sensitive_threshold.sh >> _log/panaroo_sensitive_threshold.log 2>&1 &


panaroo \
    -i ${DATA_DIR}/_all_gff/*.gff \
    -o ${PANAROO_SENSITIVE_75_OUT_DIR} \
...
panaroo \
    -i ${DATA_DIR}/_all_gff/*.gff \
    -o ${PANAROO_SENSITIVE_80_OUT_DIR} \
    --clean-mode sensitive \
...
panaroo \
    -i ${DATA_DIR}/_all_gff/*.gff \
    -o ${PANAROO_SENSITIVE_85_OUT_DIR} \
    --clean-mode sensitive \
...
panaroo \
    -i ${DATA_DIR}/_all_gff/*.gff \
    -o ${PANAROO_SENSITIVE_90_OUT_DIR} \
    --clean-mode sensitive \
...
panaroo \
    -i ${DATA_DIR}/_all_gff/*.gff \
    -o ${PANAROO_SENSITIVE_95_OUT_DIR} \
    --clean-mode sensitive \
